        ...
        <div className="container">
          ...
          <div className="text-left container">
            ...
            <ul className="list-disc p-4">
              ...
              <li>
                <p>
                  <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to yNotes.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to yNotes, accessible from <a href="https://ynotes.yorickcleerbout.be/" rel="external nofollow noopener" target="_blank">https://ynotes.yorickcleerbout.be/</a>
                </p>
              </li>
              <li>
                <p>
            ...
            <br />
            <h4 className="text-1xl sm:text-1xl md:text-2xl font-bold">
              Personal Data
            </h4>
            <p>
